                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ route('simpan_stok') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <select class="form-control" name="produksi_id" id="produksi_id">
                                            <option value="">Nama Produk</option>
                                            @foreach($dtProduksi as $pr)
                                            <option value="{{ $pr->id }}">{{ $pr->jenis_produksi }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_produksi" name="jumlah_produksi" class="form-control" placeholder="Jumlah Produksi">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="permintaan_id" name="permintaan_id" class="form-control" placeholder="Jumlah Permintaan">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="stok" name="stok" class="form-control" placeholder="Stok" readonly>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{ route('create_permintaan') }}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
