            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        <i class="fa-solid fa-store" style="font-size: 25px; margin-right: 10px;"></i>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('simpan_alternatif')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="number" id="waktu_tempuh" name="waktu_tempuh" class="form-control" placeholder="Perkiraan Waktu Tempuh">
                                    </div>
                                    <div class="form-group">
