                                ...
                                <form action="{{route('simpan_permintaan')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="alternatif_id" id="alternatif_id">
                                            ...
                                            <option value="{{$a->id}}">{{$a->nama_alternatif}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control" name="produksi_id" id="produksi_id">
                                            ...
                                            <option value="{{$p->id}}">{{$p->jenis_produksi}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="number" id="jumlah_dikirim" name="jumlah_dikirim" class="form-control" placeholder="Jumlah Dikirim">
                                    </div>
                                    <div class="form-group">
