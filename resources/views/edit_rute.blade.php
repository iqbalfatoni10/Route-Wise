            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        <i class="fa-solid fa-route" style="font-size: 25px; margin-right: 10px;"></i>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="/update_rute/{{$dtRute->id}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input type="number" id="alternatif_id" name="alternatif_id" class="form-control" placeholder="Nama Toko" value="{{ $dtRute->alternatif_id}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="waktu_tempuh" name="waktu_tempuh" class="form-control" placeholder="Waktu Tempuh" value="{{ $dtRute->waktu_tempuh}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_permintaan" name="jumlah_permintaan" class="form-control" placeholder="Jumlah Permintaan" value="{{$dtRute->jumlah_permintaan}}">
                                    </div>
                                    <div class=" form-group">
                                        <input type="number" id="biaya" name="biaya" class="form-control" placeholder="Biaya" value="{{$dtRute->biaya}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jarak_tempuh" name="jarak_tempuh" class="form-control" placeholder="Jarak Tempuh" value="{{$dtRute->jarak_tempuh}}">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_rute')}}"><strong>Ubah Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
