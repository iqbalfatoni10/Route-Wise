                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="/update_permintaan/{{$dtPermintaan->id}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input type="number" id="alternatif_id" name="alternatif_id" class="form-control" placeholder="Nama Toko" value="{{ $dtPermintaan->alternatif_id}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="produksi_id" name="produksi_id" class="form-control" placeholder="Nama Produk" value="{{ $dtPermintaan->produksi_id}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_permintaan" name="jumlah_permintaan" class="form-control" placeholder="Jumlah Permintaan" value="{{$dtPermintaan->jumlah_permintaan}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_dikirim" name="jumlah_dikirim" class="form-control" placeholder="Jumlah Dikirim" value="{{$dtPermintaan->jumlah_dikirim}}">
                                    </div>
                                    <div class=" form-group">
                                        <input type="number" id="biaya" name="biaya" class="form-control" placeholder="Biaya" value="{{$dtPermintaan->biaya}}">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_permintaan')}}"><strong>Ubah Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
