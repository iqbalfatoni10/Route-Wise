                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('simpan_rute')}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <input type="number" id="jarak_tempuh" name="jarak_tempuh" class="form-control" placeholder="Jarak Tempuh">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_rute')}}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
