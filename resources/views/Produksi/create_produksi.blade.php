            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Produksi</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('simpan_produksi')}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input type="text" id="jenis_produksi" name="jenis_produksi" class="form-control" placeholder="Jenis Produksi">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_produksi" name="jumlah_produksi" class="form-control" placeholder="Jumlah Produksi">
                                    </div>
                                    <div class="form-group">
                                        <input type="date" id="waktu_produksi" name="waktu_produksi" class="form-control" placeholder="Waktu Produksi">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_produksi')}}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
